...
def define_G(opt):
    ...
    # ----------------------------------------
    if net_type == 'dncnn':
        from models.architecture.network_dncnn import DnCNN as net
...
def define_D(opt):
    ...
    if net_type == 'discriminator_vgg_96':
        from models.architecture.network_discriminator import Discriminator_VGG_96 as discriminator
    ...
    # ----------------------------------------
        ...
        from models.architecture.network_discriminator import Discriminator_VGG_128 as discriminator
        netD = discriminator(in_nc=opt_net['in_nc'],
                             base_nc=opt_net['base_nc'],
                             ac_type=opt_net['act_mode'])
    ...
    # ----------------------------------------
        ...
        from models.architecture.network_discriminator import Discriminator_VGG_192 as discriminator
        netD = discriminator(in_nc=opt_net['in_nc'],
                             base_nc=opt_net['base_nc'],
                             ac_type=opt_net['act_mode'])
    ...
    # ----------------------------------------
        ...
        from models.architecture.network_discriminator import Discriminator_VGG_128_SN as discriminator
        netD = discriminator()

    elif net_type == 'discriminator_patchgan':
        from models.architecture.network_discriminator import Discriminator_PatchGAN as discriminator
        ...
        from models.architecture.network_discriminator import Discriminator_UNet as discriminator
        netD = discriminator(input_nc=opt_net['in_nc'],
                             ndf=opt_net['base_nc'])
...
def define_F(opt, use_bn=False):
    ...
    from models.architecture.network_feature import VGGFeatureExtractor
